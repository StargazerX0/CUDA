...
#SBATCH --output=numSam-a100.log        # Output file
#SBATCH --error=numSam-a100.log          # Error log file
#SBATCH --ntasks=1
...
./gen_sample test_signatures.fasta 500 5 1 2 200000 200000 10 30 0.1 > test_samples.fastq
echo -e "\n====> Bench...\n"
...
./gen_sample test_signatures.fasta 1000 10 1 2 200000 200000 10 30 0.1 > test_samples.fastq
echo -e "\n====> Bench...\n"
./bench-a100 test_samples.fastq test_signatures.fasta
echo -e "\n====> shared_mod...\n"
./shared_mod test_samples.fastq test_signatures.fasta
...
echo -e "\n====> 1515\n"
# ./gen_sig 500 10000 10000 0.1  > test_signatures.fasta
./gen_sample test_signatures.fasta 1500 15 1 2 200000 200000 10 30 0.1 > test_samples.fastq
echo -e "\n====> Bench...\n"
./bench-a100 test_samples.fastq test_signatures.fasta
echo -e "\n====> shared_mod...\n"
./shared_mod test_samples.fastq test_signatures.fasta
...
./gen_sample test_signatures.fasta 2500 25 1 2 200000 200000 10 30 0.1 > test_samples.fastq
echo -e "\n====> Bench...\n"
./bench-a100 test_samples.fastq test_signatures.fasta
echo -e "\n====> shared_mod...\n"
./shared_mod test_samples.fastq test_signatures.fasta
